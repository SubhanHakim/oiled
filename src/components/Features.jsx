    ...
    <section className="py-24 bg-white relative z-10 border-y border-black/5">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-500 font-inter text-lg max-w-[600px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-[#fafafa] p-8 rounded-2xl border border-black/5 hover:border-[#e5b800]/30 transition-colors duration-300 flex flex-col items-center text-center group"
            >
              <div className="p-4 bg-white rounded-xl shadow-sm mb-6 group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
